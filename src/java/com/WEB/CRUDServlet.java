...
public class CRUDServlet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                case "/countHostelApplication":
                    ...
                    totalSuccessApplication(request, response);
                    break;
                case "/offerLetter":
    ...
    private void totalHostelApplication(HttpServletRequest request, HttpServletResponse response)
        ...
        int totalSuccessApplication = userReportDAO.totalSuccessApplication();
        request.setAttribute("totalSuccessApplication", totalSuccessApplication);
        dispatcher.forward(request, response);
    }
    ...
    private void totalSuccessApplication(HttpServletRequest request, HttpServletResponse response)
            throws SQLException, IOException, ServletException {
        int totalSuccessApplication = userReportDAO.totalSuccessApplication();
        RequestDispatcher dispatcher = request.getRequestDispatcher("applicationReport.jsp");
        request.setAttribute("totalSuccessApplication", totalSuccessApplication);
