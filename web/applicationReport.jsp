                            ...
                            <div class="col-12 col-md-12">
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        ...
                                        <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">ROOM APPLICATION</h3><br>
                                        Total Room Application: <%=request.getAttribute("totalRoomApplication")%>
                                    </div><br>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="card text-center bg-white pb-2">
                                    <div class="card-body text-dark">
                                        ...
                                        <h3 class="card-title" style="font-family: 'IM Fell Great Primer', serif;">SUCCESS APPLICATION</h3><br>
                                        Total Success Application: <%=request.getAttribute("totalSuccessApplication")%>
                                    </div><br>
                                </div>
                            </div>
