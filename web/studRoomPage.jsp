                    ...
                    <div class="left grid2">
                        <div class="items">
                            ...
                            <div class="text">
                                ...
                                <p>Twins room are only available in Ibnu Sina(IS) & Ibnu Hibbah(IH) blocks. All the facilities are provide for 2 set.</p>
                            </div>
                        </div>
                    ...
                    <div class="left grid2">
                        <div class="items">
                            ...
                            <div class="text">
                                ...
                                <p>Triples room are only available in Ibnu Sina(IS) & Ibnu Hibbah(IH) blocks. All the facilities are provide for 3 set.</p>
                            </div>
                        </div>
                        ...
                        <div class="items">
                            ...
                            <div class="text">
                                ...
                                <p>Triples room are only available in Ibnu Sina(IS) & Ibnu Hibbah(IH) blocks. All the facilities are provide in 3 set.</p>
                            </div>
                        </div>
                    </div>
